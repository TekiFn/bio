...
// ==========================================================================
// 7. Interactive Canvas Particles (60 FPS Starfield & Cyber Constellation)
// ==========================================================================
function initParticleCanvas() {
    ...
    class Particle {
        constructor() {
            ...
            this.isCrimson = Math.random() > 0.7;
        }
        ...
        draw() {
            ...
            ctx.fillStyle = this.isCrimson 
                ? `rgba(255, 26, 64, ${this.alpha})` 
                : `rgba(255, 255, 255, ${this.alpha})`;
            ctx.shadowBlur = this.isCrimson ? 8 : 4;
            ctx.shadowColor = this.isCrimson ? '#ff1a40' : '#ffffff';
            ctx.fill();
        }
        ...
        for (let i = 0; i < particles.length; i++) {
            ...
            for (let j = i + 1; j < particles.length; j++) {
                ...
                if (dist < 110) {
                    ...
                    ctx.strokeStyle = `rgba(255, 26, 64, ${opacity})`;
                    ctx.lineWidth = 0.6;
                    ctx.shadowBlur = 0;
                    ctx.stroke();
                }
